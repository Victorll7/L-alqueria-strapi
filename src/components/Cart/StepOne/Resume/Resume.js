...
export function Resume(props) {
  ...
  useEffect(() => {
    ...
    forEach(frutas, (fruta) => {
      ...
      totals = {
        original: totals.original + fruta.attributes.price * fruta.quantity,
        discount:
          totals.discount + (fruta.attributes.price - price) * fruta.quantity,
        price: totals.price + price * fruta.quantity,
      };
    });
